...
if checkData == True and _runIt == True and geoCheck == True and buildMesh == True:
    ...
    print 'view factor info:'
    #pprint.pprint(testPtViewFactor)
    viewFactorNum = testPtViewFactor
    viewFactorInfo = hb_hive.addNonGeoObjToHive(viewFactorInfo, ghenv.Component)
    vpt_num = len(viewFactorNum[0])
    vf_by_srf = len(viewFactorNum[0][1]) # For each srf, viewfactor
    #print testPtZoneWeights
